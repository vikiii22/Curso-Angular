...
//
//   const interfaceCapital = Convert.toInterfaceCapital(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface InterfaceCapital {
    name:           string;
...
export class Convert {
    public static toInterfaceCapital(json: string): InterfaceCapital[] {
        return cast(JSON.parse(json), a(r("InterfaceCapital")));
    }

    public static interfaceCapitalToJson(value: InterfaceCapital[]): string {
        return JSON.stringify(uncast(value, a(r("InterfaceCapital"))), null, 2);
    }
}
