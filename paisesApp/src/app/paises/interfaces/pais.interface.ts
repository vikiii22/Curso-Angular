// To parse this data:
//
//   import { Convert, InterfacePaises } from "./file";
//
//   const interfacePaises = Convert.toInterfacePaises(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface InterfacePaises {
    name:           string;
...
export class Convert {
    public static toInterfacePaises(json: string): InterfacePaises {
        return cast(JSON.parse(json), r("InterfacePaises"));
    }

    public static interfacePaisesToJson(value: InterfacePaises): string {
        return JSON.stringify(uncast(value, r("InterfacePaises")), null, 2);
    }
}
